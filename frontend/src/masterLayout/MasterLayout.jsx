    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div className="sidebar-menu-area">
          <ul className="sidebar-menu" id="sidebar-menu">
            ...
            {/* crud Functionality of LMS start */}
            ...
            <li>
              ...
              >
                ...
                <span>Catalogue List</span>
              </NavLink>
            </li>

            {/* crud Functionality of LMS end */}
      ...
      >
        ...
        <footer className="d-footer">
          <div className="row align-items-center justify-content-between">
            <div className="col-auto">
              <p className="mb-0">© 2025 GemsDashboard. All Rights Reserved.</p>
            </div>
            <div className="col-auto">
              <p className="mb-0">
                Powered by <span className="text-primary-600">1or8.com.np</span>
              </p>
            </div>
          </div>
        </footer>
